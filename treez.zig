...
pub const TREE_SITTER_LANGUAGE_VERSION = 15;
...
pub const Language = opaque {
    ...
    pub fn getLanguageAbiVersion(language: *const Language) u32 {
        return externs.ts_language_abi_version(language);
    }

    pub fn getLanguageName(language: *const Language) [*:0]const u8 {
        return std.mem.span(externs.ts_language_name(language));
    }
    ...
    pub const externs = struct {
        ...
        pub extern fn ts_language_abi_version(?*const Language) u32;
        pub extern fn ts_language_name(?*const Language) [*:0]const u8;
    };
};
